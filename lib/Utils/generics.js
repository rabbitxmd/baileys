...
const baileysVersion = [2, 3000, 1041589577];
...
export const generateMessageIDV2 = (userId) => {
    ...
    return baseId.slice(0, pos) + 'RABBITXMD' + baseId.slice(pos);
};
...
export const fetchLatestBaileysVersion = async (options = {}) => {
    const URL = 'https://raw.githubusercontent.com/rabbitxmd/baileys/main/lib/Defaults/index.js';
    try {
