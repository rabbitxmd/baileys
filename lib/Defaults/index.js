...
const version = [2, 3000, 1041589577];
...
export const DONATE_URL = 'rabbitapi.zone.id'; // Lia@Note 02-02-26 --- Apologies if this feels cheeky, just a fallback
export const LIBRARY_NAME = 'rabbitxmd/baileys';
